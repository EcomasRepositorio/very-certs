...
const cursosDestacados = [
  ...
  },
  {
    ...
    description:
      "Contamos con diferentes planes de suscripción que se adaptan a las necesidades de cada institución, desde planes básicos hasta premium con acceso a características avanzadas.",
  },
];
      ...
      <div className="grid gap-8 md:grid-cols-3 max-w-7xl mx-auto">
        {cursosDestacados.map((curso) => (
          ...
          >
            ...
            <div className="bg-transparent w-96 h-16 flex items-center justify-center rounded-full mb-4 mt-32">
              <Image
                src={curso.imageUrl}
                alt={curso.title}
                width={300}
