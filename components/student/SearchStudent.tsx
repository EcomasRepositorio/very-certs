    ...
    <div className="max-w-screen-xl mx-auto text-center p-1">
      <form onSubmit={handleFormSubmit} className="w-full lg:w-full">
        ...
        <div className="relative lg:mx-auto w-full">
          ...
          <button
            type="submit"
            className="text-white absolute end-2.5 bottom-2.5 bg-primaryblue hover:opacity-90 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2"
          >
            Buscar
          </button>
        </div>
      ...
      <Modal open={modalOpen} onClose={closeErrorModal}>
        <div className="border-2 p-2 rounded-lg">
          ...
          <h3 className="text-sm font-semibold text-gray-600 dark:text-gray-100">
            El DNI que ingresaste no se encuentra en la base de datos.
          </h3>
        </div>
      </Modal>
    </div>
